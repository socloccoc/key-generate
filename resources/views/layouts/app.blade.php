            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @guest
                        ...
                        @else
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('app.create') }}">{{ 'Create App' }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('key.create') }}">{{ 'Key Generate' }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('key.index') }}">{{ 'Key Manager' }}</a>
                            </li>
